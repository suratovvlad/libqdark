...
DEFINES += LIBQDARK_VERSION_MAJOR=$${VER_MAJ}
DEFINES += LIBQDARK_VERSION_MINOR=$${VER_MIN}
DEFINES += LIBQDARK_VERSION_PATCH=$${VER_PAT}

DEFINES += LIBQDARK_VERSION=\\\"v$${PROJECT_VERSION}\\\"
